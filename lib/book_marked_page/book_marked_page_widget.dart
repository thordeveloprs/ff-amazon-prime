...
class BookMarkedPageWidget extends StatefulWidget {
  const BookMarkedPageWidget({Key? key}) : super(key: key);

  @override
  _BookMarkedPageWidgetState createState() => _BookMarkedPageWidgetState();
}

class _BookMarkedPageWidgetState extends State<BookMarkedPageWidget> {
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        ...
                        children: List.generate(
                            columnNewsDetailsRecordList.length, (columnIndex) {
